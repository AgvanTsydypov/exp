...
BF_MAX_THINK_TOKENS = 8192          # бюджет "мыслей" для фикса
BF_NUM_IGNORE = 1                  # сколько раз игнорировать закрытие мыслей
...
FIX_MAX_NEW_TOKENS = 2048          # лимит токенов для итогового кода-фикса
...
base_name = "/home/agvanu/models/qwen-0.5B-cotData"
